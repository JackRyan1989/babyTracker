...
export default function ViewData(props) {
    ...
    return (
        ...
        <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={12} md={6} lg={6}><Paper className={classes.paper}></Paper></Grid>
        </Grid>
        <Grid container spacing={2}>
            <Grid item xs={12} sm={12} md={12} lg={12}><Paper className={classes.paper}>Placeholder</Paper></Grid>
        </Grid>
        </>
    )
};